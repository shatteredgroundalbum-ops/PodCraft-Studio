...
export function Dashboard() {
  ...
  // Pick most recent project as "current" (highest lastSaved or last in array)
  const currentProject = projects[projects.length - 1];
  const currentEpisode = currentProject ?
  episodes.find((e) => e.projectId === currentProject.id) :
  undefined;
  ...
  filter((t) => {
    ...
    return due && due >= today && due <= weekFromNow;
  }).
  slice(0, 5);
  ...
  const mediaIconFor = (cat: string) => {
    if (cat === 'audio' || cat === 'studio' || cat === 'sfx')
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-10 text-center">
              ...
              <p className="text-sm text-gray-500 mb-6 max-w-md mx-auto">
                Create your first project to start recording, editing, and
                publishing podcasts.
              </p>
              <button
              ...
              <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div className="flex-1 min-w-0">
                  ...
                  <>
                        ...
                        <span>Episode: {currentEpisode.title}</span>
                      </>
                  }
                    {currentTask &&
                  <>
                ...
                <div className="flex flex-wrap gap-3">
                  <Link
                  to="/studio"
                  className="inline-flex items-center gap-2 px-4 py-2.5 bg-white text-violet-700 rounded-lg text-sm font-semibold hover:bg-violet-50 transition-colors">
                  ...
                  <Link
                  to="/studio"
                  className="inline-flex items-center gap-2 px-4 py-2.5 bg-white/10 text-white rounded-lg text-sm font-medium hover:bg-white/20 backdrop-blur-sm transition-colors">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="border border-gray-100 rounded-lg p-3">
                <div className="flex items-center gap-2 text-gray-500 mb-1">
                  ...
                  <span className="text-xs font-medium">Audio Device</span>
                </div>
              ...
              <div className="border border-gray-100 rounded-lg p-3">
                <div className="flex items-center gap-2 text-gray-500 mb-1">
                  ...
                  <span className="text-xs font-medium">OpenDAW</span>
                </div>
                <p className="text-sm font-semibold text-gray-900">Idle</p>
              </div>
              <div className="border border-gray-100 rounded-lg p-3">
                <div className="flex items-center gap-2 text-gray-500 mb-1">
                  <SparklesIcon className="w-3.5 h-3.5" />
                  <span className="text-xs font-medium">AI Producer</span>
                </div>
                <p className="text-sm font-semibold text-gray-900">Idle</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 divide-y divide-gray-100">
              ...
              <div className="p-8 text-center">
                  ...
                  <p className="text-xs text-gray-500">
                    Recordings, uploads, and exports will appear here.
                  </p>
                </div> :
        ...
        <section>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <Link
              to="/studio"
              className="bg-white rounded-xl border border-gray-200 p-4 flex flex-col items-start gap-2 hover:border-violet-300 hover:shadow-sm transition-all group">
              
              <div className="w-9 h-9 rounded-lg bg-violet-50 flex items-center justify-center">
                <MicIcon className="w-4 h-4 text-violet-600" />
              </div>
              <span className="text-sm font-semibold text-gray-900">
                Open Studio
              </span>
            ...
            <Link
              ...
              <div className="w-9 h-9 rounded-lg bg-violet-50 flex items-center justify-center">
                <UploadIcon className="w-4 h-4 text-violet-600" />
              </div>
              <span className="text-sm font-semibold text-gray-900">
                Import Media
              </span>
