...
import { PodifyLogo } from './PodifyLogo';
import {
  HomeIcon,
  FolderIcon,
  CalendarIcon,
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col h-full flex-shrink-0">
        ...
        <div className="px-4 mb-6">
          <button
            ...
            className="w-full bg-violet-600 hover:bg-violet-700 text-white rounded-lg py-2.5 px-4 flex items-center justify-center gap-2 font-medium transition-colors shadow-sm">
            ...
            <>
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 p-4 z-50">
                      ...
                      <p className="text-sm text-gray-500 mb-3">
                        Find answers in our documentation or contact support.
                      </p>
                      <a
                    href="#"
                ...
                <div className="relative" ref={notificationsRef}>
                  ...
                  className="text-gray-400 hover:text-gray-600 relative transition-colors p-1">
                ...
                <div className="absolute right-0 mt-2 w-60 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                        ...
                        <ScaleIcon className="w-4 h-4 text-gray-400" /> Legal &
                        Policies
                      </Link>
                      <Link
                    to="/help"
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                        ...
                        <LifeBuoyIcon className="w-4 h-4 text-gray-400" /> Help
                        & Support
                      </Link>
                      <Link
                    to="/about"
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                        ...
                        <InfoIcon className="w-4 h-4 text-gray-400" /> About
                        Podify
                      </Link>
                      ...
                      className="w-full flex items-center gap-2 px-4 py-2 text-sm text-red-600 hover:bg-red-50 text-left">
                          ...
                          <LogOutIcon className="w-4 h-4 text-red-500" /> Sign
                          Out
                        </button>
                      </div>
                    </div>
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-sm text-gray-500 mb-6">
                You'll be returned to the sign-in screen. Any unsaved work in
                the Studio should be saved first.
              </p>
