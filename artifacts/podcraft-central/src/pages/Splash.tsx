...
export function Splash() {
  ...
  }, [minTimeElapsed, isLoading, user, navigate]);
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
        <motion.div
          ...
          <motion.div
            ...
            <p className="text-gray-400 text-sm tracking-wide">Loading your workspace…</p>
          </motion.div>
        </motion.div>
        ...
        <motion.p
          ...
          className="absolute bottom-8 text-gray-500 text-sm tracking-wide">
